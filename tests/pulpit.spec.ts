...
test.describe('Pulpit test', () => {
    ...
    test('Przelew', async ({ page }) => {
        ...
        await page.getByTestId('password-input').fill('test2025');
        ...
        await expect(page.locator('#show_messages')).toHaveText('Przelew wykonany! Chuck Demobankowy - 120,00PLN - zwrot środków')
    });
